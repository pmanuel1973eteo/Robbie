...
const DEFAULT_SETTINGS = {
  ...
  showDebug:      true,
  sensitivity:    1.0,
  serverUrl:      'https://dash.robbie.techcaresenior.eu',
  ...
  useEffect(() => {
    AsyncStorage.getItem(SETTINGS_KEY).then((json) => {
      ...
      try {
        ...
        if (!merged.serverUrl || merged.serverUrl === 'http://techcaresenior.eu:5001' || merged.serverUrl === 'https://techcaresenior.eu') merged.serverUrl = DEFAULT_SETTINGS.serverUrl;
        setSettings(merged);
